...
function downloadPdf() {
  try {
    ...
    doc.setFillColor(230, 203, 48); // Brand blue color
    ...
    doc.text(`College Predictor Results - Rank: ${userRank}`, 15, 35);

    // Reset colors for content
    doc.setTextColor(0);
    
    // Add table headers with styling
    doc.setFillColor(230, 203, 48);
    doc.rect(10, 45, 190, 10, 'F');
    doc.setFontSize(12);
    doc.setFont('helvetica', 'bold');
    doc.text('Institute Name', 15, 52);
    doc.text('Program Name', 70, 52);
    doc.text('Opening', 140, 52);
    doc.text('Closing', 170, 52);
